export const topSellers = [
    ...
    },
    {
        ...
        releaseYear: 1984,
        categories: ['Puzzle'],
        description: 'Tetris is a tile-matching puzzle video game originally designed and programmed by Alexey Pajitnov. In Tetris, geometric shapes called Tetriminos fall from the top of the screen, and the player must rotate and arrange them to create horizontal lines without any gaps. When a line is completed, it disappears, and the player earns points.',
        platforms: ['Various'],
    ...
    },
    {
        ...
        releaseYear: 2006,
        categories: ['Sports'],
        description: "Wii Sports is a sports video game developed and published by Nintendo. It was designed as a launch title for the Nintendo Wii console and features a collection of five sports simulations, including tennis, baseball, bowling, golf, and boxing. The game utilizes the Wii Remote controller's motion-sensing capabilities for immersive gameplay.",
    ...
    },
    {
        ...
        description: 'Super Mario Bros. is a platform game developed and published by Nintendo. It follows Mario and Luigi as they embark on a quest to rescue Princess Toadstool from the villainous King Bowser. The game is renowned for its side-scrolling gameplay, power-ups like the Super Mushroom and Fire Flower, and the iconic characters that have become staples of the Nintendo franchise.',
    ...
    },
    {
        ...
        releaseYear: 2017,
        categories: ['Racing'],
        description: 'Mario Kart 8 Deluxe is a kart racing game developed by Nintendo. It is the enhanced version of Mario Kart 8 for the Nintendo Switch console. Players race against each other on various tracks, using power-ups and items to gain an advantage. The game features a diverse roster of characters from the Mario series and introduces new elements such as anti-gravity racing.',
        platforms: ['Nintendo Switch'],
        logo: 'mario-kart-logo.jpg'
    }
];
//# sourceMappingURL=topSellers.js.map